    ...
    <main className="relative min-h-screen overflow-hidden bg-[#0A0A0A] px-4 py-4 text-[#F0EDE8]">
      ...
      <div className="relative mx-auto w-full max-w-[390px] pb-12">
        ...
        <section className="mt-4 px-2">
          <h1 className="text-[32px] font-extrabold leading-[0.92] tracking-[-0.64px] text-[#CA3631]">
            The Room Speaks
          </h1>
        ...
        <section className="mt-8 px-2">
          <div className="h-[358px] rounded-[8px] border border-[#CA3631]/70 bg-[#0A0A0A] p-4">
        ...
        <section className="mt-8 space-y-5 px-2 text-[16px] leading-snug text-[#F0EDE8]">
          ...
          <p className="text-[13px] font-extrabold uppercase tracking-[-0.26px] text-[#CA3631]">
          ...
          <div className="flex items-center justify-between gap-4">
            <Link
              to="/"
              className="text-[13px] font-extrabold uppercase tracking-[-0.26px] text-[#CA3631] transition-colors hover:text-[#ff655f]"
            >
              Retry Experience →
            </Link>
          </div>
        ...
        <section className="mt-8 space-y-4 px-2">
          <button
            type="button"
            className="inline-flex min-h-11 items-center justify-center bg-[#CA3631] px-8 py-4 text-[13px] font-semibold text-[#F0EDE8] transition-colors hover:bg-[#d3423d]"
          >
            Share My Thoughts
          </button>
